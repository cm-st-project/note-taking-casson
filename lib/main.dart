...
import 'package:this_is_a_project/settings_page.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  String text = "Welcome to Casson's Voice Note Taking!";
  ...
  void STJ() {
    ...
    Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) =>
                wahooo(averyverycreativename, "Untitled Note", linkURL)));
  }
